...
if __name__ == "__main__":
    ...
    # # 1. No flux profiling, no fit
    # invCov = sample_histogram.GetInverseCovarianceMatrix(sansFlux=False)

    # chi2, penalty = Chi2DataMC(
    #     sample_histogram,
    #     invCov=invCov,
    #     marginalize=False,
    #     useOsc=False,
    ...
    # print("chi2 (no profiling, sansFlux=False) =", chi2)
    # print("penalty =", penalty)

    # # optional extra debugging
    # data = np.array(sample_histogram.GetDataHistogram())[1:-1]
    # mc   = np.array(sample_histogram.GetMCHistogram())[1:-1]
    # diff = data - mc

    # print("N bins =", len(diff))
    # print("data   =", data)
    # print("mc     =", mc)
    # print("diff   =", diff)
