...
run --playlist le1_p6_test --i /pnfs/minerva/persistent/users/qvuong/CCNUE_selection_2025-10-22-100517_hists/ --cal_POT --ntuple_tag MAD --selection_tag elastic_noETheta2 --mc_only
