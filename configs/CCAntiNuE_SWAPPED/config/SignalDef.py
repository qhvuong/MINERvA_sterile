...
TRUTH_CATEGORIES = OrderedDict()
TRUTH_CATEGORIES["NuEPi+"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == 211
TRUTH_CATEGORIES["NuEPi-"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == -211
TRUTH_CATEGORIES["NuEK+"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == 321
TRUTH_CATEGORIES["NuEK-"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == -321
TRUTH_CATEGORIES["NuEK0L"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == 130
TRUTH_CATEGORIES["NuEK0"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == 310
TRUTH_CATEGORIES["NuEK0S"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == 311
TRUTH_CATEGORIES["NuEMu-"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == 13
TRUTH_CATEGORIES["NuEMu+"] = lambda event:  IsNuE(event) and event.mc_fr_nuParentID == -13
TRUTH_CATEGORIES["AntiNuEPi+"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == 211
TRUTH_CATEGORIES["AntiNuEPi-"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == -211
TRUTH_CATEGORIES["AntiNuEK+"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == 321
TRUTH_CATEGORIES["AntiNuEK-"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == -321
TRUTH_CATEGORIES["AntiNuEK0L"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == 130
TRUTH_CATEGORIES["AntiNuEK0"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == 310
TRUTH_CATEGORIES["AntiNuEK0S"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == 311
TRUTH_CATEGORIES["AntiNuEMu-"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == 13
TRUTH_CATEGORIES["AntiNuEMu+"] = lambda event:  IsAntiNuE(event) and event.mc_fr_nuParentID == -13
