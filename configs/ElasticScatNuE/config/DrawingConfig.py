...
#     {
#         "title" : "CC #nu_{e}",
#         "cate": {"CCNuE", "CCNuEWrongSign", "CCOther"},
#         "color": COLORS[2]
#     },
#     # "NCCOH":{
#     #     "title" : "NCCoh",
...
NuEElasticAllBackgroundDecomp = {
    ...
    "CCNuEWrongSignQE" : {
        "title" : "CCNuEWrongSignQE",
        "color" : COLORS[3]
    },
    "CCNuEWrongSign" : {
        "title" : "CCNuEWrongSign",
        "color" : COLORS[4]
    },
    "CCNuEQE" :
    {
...
NuEElasticBackgroundDecomposition = {
    ...
    "CCNuEWrongSign" : {
        "title" : "CC #nu_{e} wrong sign",
        "cate"  : {"CCNuEWrongSign", "CCNuEWrongSignQE"},
        "color" : COLORS[2]
    },
    "CCNuMu": {
        "title" : "CC #nu_{#mu}", 
...
NuEElastic1Sig3Bkgs = {
    ...
    "BkgCC" : {
        "title" : "CC #nu_{e} Others",
        "cate"  : {"CCNuEQE", "CCNuE2p2h", "CCNuEDelta", "CCNuEDIS", "CCNuE", "CCNuEWrongSign", "CCNuEWrongSignQE", "CCNuMu", "CCNuMuWrongSign", "CCPi0", "CCPi", "CCOther"},
        "color" : COLORS[4]
    },
    "BkgPhoton": {
        "title" : "NC Coh #pi^{0}", 
...
DefaultPlotters={
    ...
    "profileX":{"func":PlotTools.CategoryProfileX,
                     "args": (NuEElastic1Sig1Bkg,)},
    "profileXNoFit":{"func":PlotTools.CategoryProfileXNoFit,
                     "args": (NuEElastic1Sig1Bkg,)},
    "projectionXNoFit":{"func":PlotTools.CategoryProjectionXNoFit,
                     "args": (NuEElastic1Sig1Bkg,)},
    "projectionYNoFit":{"func":PlotTools.CategoryProjectionYPerXBin,
                     "args": (NuEElastic1Sig1Bkg,)},
...
####Hang Plots#####################
  ...
  #    "scale" : lambda histHolder:histHolder.POTScale(False)}, 
    ...
    # {"name":"dThetaY vs Lepton Vertex Y",
    #    "plot_type" : "profileX"},  
    # {"name":"dThetaY vs Lepton Vertex Y",
    #    "plot_type" : "category_hist"},  
    ...
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs Vertex R",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs dVertex X",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs dVertex Y",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs dVertex Z",
    #    "plot_type" : "category_hist"},
    # {"name":"dThetaX vs true pHatZ",
    #    "plot_type" : "category_hist"},    
    # {"name":"dThetaX vs true Theta",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs Front dEdX",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs ConeOutsideE",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs NeighborhoodE",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs Lepton Energy",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaX vs Available Energy",
    #    "plot_type" : "category_hist"}, 
    # {"name":"dThetaX vs Hex Edge Distance",
    #    "plot_type" : "category_hist"},   
    # {"name":"dThetaX vs EMLikeTrackScore",
    #    "plot_type" : "category_hist"},  
    ...
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaY vs Vertex R",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaY vs dVertex X",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaY vs dVertex Y",
    #    "plot_type" : "category_hist"},  
    # {"name":"dThetaY vs dVertex Z",
    #    "plot_type" : "category_hist"},
    # {"name":"dThetaY vs true pHatZ",
    #    "plot_type" : "category_hist"},    
    # {"name":"dThetaY vs true Theta",
    #    "plot_type" : "category_hist"},  
    ...
    #    "plot_type" : "category_hist"},   
    # {"name":"dThetaY vs EMLikeTrackScore",
    #    "plot_type" : "category_hist"},  
    ...
    #    "plot_type" : "category_hist"}, 
    # {"name":"PhatX_reco vs Vertex X In Det Coordinate",
    #    "plot_type" : "category_hist"}, 
    # {"name":"PhatX_true vs Vertex X In Det Coordinate",
    #    "plot_type" : "category_hist"}, 
    ...
    #    "plot_type" : "category_hist"}, 
    # # {"name":"PhatX_reco vs Vertex Y In Det Coordinate",
    # #    "plot_type" : "category_hist"}, 
    # # {"name":"PhatX_true vs Vertex Y In Det Coordinate",
    # #    "plot_type" : "category_hist"},
    ...
    # {"name":"dPmag_frac vs Vertex Z In Det Coordinate",
    #    "plot_type" : "projectionYNoFit"}, 
    # {"name":"dPmag_frac vs Lepton Energy",
    #    "plot_type" : "projectionYNoFit"}, 
    # {"name":"dPmag_frac vs HCAL Fraction",
    #    "plot_type" : "projectionYNoFit"}, 
