...
N4_TUNE ={
    ...
    "CATEGORY_FACTORS" : {
        ...
        "NCPi0":       "dEdX",
        "NCCohPi0":    "dEdX",
        "CCNuEWrongSign": "Etheta",
        "CCNuE":          "Etheta",
        "CCOther":        "Etheta",
        "NC":             "Etheta",
        "NCDiff":         "Etheta",
        "ElasticOutOfKinematic": "Etheta",
    }
}

N4_TUNE["SCALE_FACTORS"]["dEdX"]=PlotConfig.NEUTRINO4_EE_BINNING
N4_TUNE["SCALE_FACTORS"]["Etheta"]=PlotConfig.NEUTRINO4_EE_BINNING



N4_TUNE_DEDX = {
    "HIST_OBSERVABLE": "Visible Energy",
    "HIST_TO_FIT":     "Visible Energy",
    "Yaxis": False,
    "REGULATION_PARAMETER": 0.0,
    "SCALE_FACTORS": OrderedDict(),
    "CATEGORY_FACTORS": {
        # Tuned by dEdX sideband:
        "PhotonMisID": "dEdX",
        "NCPi0":       "dEdX",
        "NCCohPi0":    "dEdX",
        # (optionally) "NC": "dEdX",
        # (optionally) "NCDiff": "dEdX",
        # Everything not listed here is *fixed* in this fit.
    },
}

N4_TUNE_DEDX["SCALE_FACTORS"]["dEdX"] = PlotConfig.NEUTRINO4_EE_BINNING
...
N4_TUNE_ETHETA2 = {
    ...
    "CATEGORY_FACTORS": {
        ...
        "NCDiff":         "Etheta",
        "ElasticOutOfKinematic": "Etheta",
        # Probably NOT the true nu+e signal:
        # "NuEElasticE": "Signal",
        # "NuEElasticMu": "Signal",
    },
}

N4_TUNE_ETHETA2["SCALE_FACTORS"]["Etheta"] = PlotConfig.NEUTRINO4_EE_BINNING
...
Tune_Strategy_map = {
    ...
    "visE_tune":VISE_TUNE,
    "N4_tune":N4_TUNE,
    "N4_tune_dEdX":N4_TUNE_DEDX,
    "N4_tune_Etheta":N4_TUNE_ETHETA2,
    "no_tune":NO_TUNE,
